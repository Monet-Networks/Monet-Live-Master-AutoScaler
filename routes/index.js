...
admin.get('/engine/reset-engine-state', (req, res) => {
...
admin.post('/auth/register-user', userController.registerUser);

admin.post('/auth/register-invited-user', userController.registerInvitedUser);

admin.post('/auth/login', userController.login);

admin.post('/auth/google', userController.googleAuth);

admin.post('/auth/microsoft', userController.microsoftAuth);

admin.put('/auth/forget-password', userController.forgetPassword);

admin.put('/auth/reset-password/:token', userController.resetPassword);
